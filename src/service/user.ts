import { UserDocument, UserModelType } from '../entity/user'
...
class UserService {
   ...
   */
  public async getOneByEmail(email: string): Promise<UserDocument | null> {
   ...
   */
  public async getOneById(id: string): Promise<UserDocument | null> {
